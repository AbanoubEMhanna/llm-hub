...
> **Goal:** The best local-first AI workbench — model management & hardware awareness of **LM Studio**, the code-first developer workflow of **OpenCode**, wrapped in a **Linear/Vercel-inspired modern UI** that feels fast, focused, and professional.
>
> **Legend:**
> - `[x]` Done & on main
> - `[ ]` Not started
...
### Hardware Awareness
- [x] System RAM bar — live used / total
...
- [ ] Multi-collection query — search all collections at once
