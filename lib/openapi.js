    ...
    paths: {
      ...
      '/v1/rag/query': {
        post: {
          ...
          description: 'Provide `collection_id` to search a single collection, or `collection_ids` to search several together. Omit both to search across every collection at once, with results merged and re-ranked by score.',
          requestBody: {
            required: true,
            content: {
              'application/json': {
